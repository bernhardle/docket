function validator(theForm)
{
  ...
  {
    alert("Geben Sie eine Zahl in das Feld \"1. Wiedervorlage [Tag]\" ein.");
    theForm.dd2.focus();
    return (false);
  }
  ...
  if (!allValid)
  {
    alert("Geben Sie nur eine Zahl in das Feld \"1. Wiedervorlage [Tag]\" ein.");
    theForm.dd2.focus();
    return (false);
  }
  var monlen = 0 ;
  ...
  if (chkVal != "" && !(prsVal > 0 && prsVal <= monlen))
  {
    alert("Geben Sie eine Zahl zwischen 1 und " + monlen + " in das Feld \"1. Wiedervorlage [Tag]\" ein.");
    theForm.dd2.focus();
    return (false);
  }
  ...
  {
    alert("Geben Sie eine Zahl mit 4 Stellen in das Feld \"1. Wiedervorlage [Jahr]\" ein.");
    theForm.yyyy2.focus();
    return (false);
  }
  ...
  if (!allValid)
  {
    alert("Geben Sie nur Ziffern in das Feld \"1. Wiedervorlage [Jahr]\" ein.");
    theForm.yyyy2.focus();
    return (false);
  }
  ...
  if (chkVal != "" && !(prsVal >= 2000 && prsVal <= 2020))
  {
    alert("Geben Sie eine Zahl zwischen 2000 und 2020 in das Feld \"1. Wiedervorlage [Jahr]\" ein.");
    theForm.yyyy2.focus();
    return (false);
  }
  ...
  {
    alert("Die 1. Wiedervorlage muss in der Zukunft liegen.");
    theForm.mm2.focus() ;
    return (false);
  }
  ...
  {
    alert("Die 1. Wiedervorlage muss vor dem Fristende liegen.");
    theForm.mm2.focus() ;
    return (false);
  }

  if (theForm.dd3.value.length < 1)
  {
    alert("Geben Sie eine Zahl in das Feld \"2. Wiedervorlage [Tag]\" ein.");
    theForm.dd3.focus();
    return (false);
  }

  var checkOK = "0123456789";
  var checkStr = theForm.dd3.value;
  var allValid = true;
  var decPoints = 0;
  var allNum = "";
  for (i = 0;  i < checkStr.length;  i++)
  ...
  if (!allValid)
  {
    alert("Geben Sie nur eine Zahl in das Feld \"2. Wiedervorlage [Tag]\" ein.");
    theForm.dd3.focus();
    return (false);
  }
  var monlen = 0 ;
  switch (theForm.mm3.value) {
    case "1" :
        monlen = 31 ;
      break ;
    case "2" :
  ...
  if (chkVal != "" && !(prsVal > 0 && prsVal <= monlen))
  {
    alert("Geben Sie eine Zahl zwischen 1 und " + monlen + " in das Feld \"2. Wiedervorlage [Tag]\" ein.");
    theForm.dd3.focus();
    return (false);
  }

  if (theForm.yyyy3.value.length != 4)
  {
    alert("Geben Sie eine Zahl mit 4 Stellen in das Feld \"2. Wiedervorlage [Jahr]\" ein.");
    theForm.yyyy3.focus();
    return (false);
  }

  var checkOK = "0123456789";
  var checkStr = theForm.yyyy3.value;
  var allValid = true;
  var decPoints = 0;
  var allNum = "";
  for (i = 0;  i < checkStr.length;  i++)
  ...
  if (!allValid)
  {
    alert("Geben Sie nur Ziffern in das Feld \"2. Wiedervorlage [Jahr]\" ein.");
    theForm.yyyy3.focus();
    return (false);
  }
  ...
  if (chkVal != "" && !(prsVal >= 2000 && prsVal <= 2020))
  {
    alert("Geben Sie eine Zahl zwischen 2000 und 2020 in das Feld \"2. Wiedervorlage [Jahr]\" ein.");
    theForm.dd3.focus();
    return (false);
  }

  if (parseInt (theForm.yyyyn.value) > parseInt (theForm.yyyy3.value) 
	|| (parseInt (theForm.yyyyn.value) == parseInt (theForm.yyyy3.value) && parseInt (theForm.mmn.value) > parseInt (theForm.mm3.value))
	|| (parseInt (theForm.yyyyn.value) == parseInt (theForm.yyyy3.value) && parseInt (theForm.mmn.value) == parseInt (theForm.mm3.value) && parseInt (theForm.ddn.value) >= parseInt (theForm.dd3.value)))
  {
    alert("Die 2. Wiedervorlage muss in der Zukunft liegen.");
    theForm.mm3.focus() ;
    return (false);
  }
  if (parseInt (theForm.yyyy3.value) > parseInt (theForm.yyyy1.value) 
	|| (parseInt (theForm.yyyy3.value) == parseInt (theForm.yyyy1.value) && parseInt (theForm.mm3.value) > parseInt (theForm.mm1.value))
	|| (parseInt (theForm.yyyy3.value) == parseInt (theForm.yyyy1.value) && parseInt (theForm.mm3.value) == parseInt (theForm.mm1.value) && parseInt (theForm.dd3.value) >= parseInt (theForm.dd1.value)))
  {
    alert("Die 2. Wiedervorlage muss vor dem Fristende liegen.");
    theForm.mm3.focus() ;
    return (false);
  }
  if (parseInt (theForm.yyyy3.value) == parseInt (theForm.yyyy2.value) && parseInt (theForm.mm3.value) == parseInt (theForm.mm2.value) && parseInt (theForm.dd3.value) == parseInt (theForm.dd2.value))
  {
    alert("Die 1. und 2. Wiedervorlage dürfen nicht auf einen Tag fallen.");
    theForm.mm3.focus() ;
    return (false);
  }
