...
import dynamic.listfetch.ListFetch ;
...
final public class SelectionServlet extends MyBasicHttpServlet {
  ...
  protected void reload () throws ServletException {
    try {
      ...
      j4 = d.jump (310) ;
      j5 = d.jump (311) ;
      param__id = y1.getProperty ("param__id") ;	
      g1 = (ListFetch) Class.forName (y1.getProperty ("listfetch")).newInstance () ;
    }
    catch (Exception e) {
  ...
  public void doGet (HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    if (u == null) {
      ...
      try {
        Map m = new HashMap () ;
        m.put (param__id, new Pair (g1.fetch (new DataSourceScheduleRead (getInitParameter("schedule"))), new Integer (0))) ;
